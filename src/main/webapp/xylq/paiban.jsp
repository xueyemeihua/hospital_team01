        ...
        <div class="col-xs-12 col-sm-8 col-md-9" style="float:right">
            ...
            <div class="right_contents">
                <table border="0px" cellpadding="0px" cellspacing="0px">
                    ...
                    <c:forEach var="staff" items="${stafsByGroupOnDept}">
                        <tr>
                            <td width="100px" height="50px">${staff.deptname}</td>
                            <c:if test="${staff.one=='有班'}">
                                <td width="100px" height="50px">${staff.stafname}</td>
                            </c:if>
                            <c:if test="${staff.one=='无班'}">
                                <td width="100px" height="50px"></td>
                            </c:if>
                            <c:if test="${staff.two=='有班'}">
                                <td width="100px" height="50px">${staff.stafname}</td>
                            </c:if>
                            <c:if test="${staff.two=='无班'}">
                                <td width="100px" height="50px"></td>
                            </c:if>
                            <c:if test="${staff.three=='有班'}">
                                <td width="100px" height="50px">${staff.stafname}</td>
                            </c:if>
                            <c:if test="${staff.three=='无班'}">
                                <td width="100px" height="50px"></td>
                            </c:if>
                            <c:if test="${staff.four=='有班'}">
                                <td width="100px" height="50px">${staff.stafname}</td>
                            </c:if>
                            <c:if test="${staff.four=='无班'}">
                                <td width="100px" height="50px"></td>
                            </c:if>
                            <c:if test="${staff.five=='有班'}">
                                <td width="100px" height="50px">${staff.stafname}</td>
                            </c:if>
                            <c:if test="${staff.five=='无班'}">
                                <td width="100px" height="50px"></td>
                            </c:if>
                            <c:if test="${staff.six=='有班'}">
                                <td width="100px" height="50px">${staff.stafname}</td>
                            </c:if>
                            <c:if test="${staff.six=='无班'}">
                                <td width="100px" height="50px"></td>
                            </c:if>
                            <c:if test="${staff.seven=='有班'}">
                                <td width="100px" height="50px">${staff.stafname}</td>
                            </c:if>
                            <c:if test="${staff.seven=='无班'}">
                                <td width="100px" height="50px"></td>
                            </c:if>
                        </tr>
                    </c:forEach>
