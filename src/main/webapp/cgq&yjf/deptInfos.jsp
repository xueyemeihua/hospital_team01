                  ...
                  <div id="contes" style="">
                    <div style="width:500px;height:40px;">
                      ...
                      <form style=" margin-left: 50px;"  >
                        科室名称：<input type="text" id="checkDeptname" name="deptname" value="" width="60px" ><br>
                        <font id="deptFont"></font><br>
                        <input style=" margin-left: 50px;" type="submit" value="提交" id="stamp" onclick="javascript:this.form.action='/addDeptinfo'">
            ...
            <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
              ...
              <tbody>
                <c:forEach items="${deptinfos}" var="deptinfo">
                    <tr align="center">
                       <td>${deptinfo.deptid}</td>
                       <td>${deptinfo.deptname}</td>
                       <td>
                         <button id="open_btn" class="btn" onclick="show(${deptinfo.deptid},'${deptinfo.deptname}')">详情</button>
...
<script >
  ...
  $("#checkDeptname").blur(function () {
      $.get("http://localhost:8080/checkDeptname","deptname="+$("#checkDeptname").val(),function (data) {
        var stamp = document.getElementById("stamp")
        if(data==1){
          stamp.disabled=true
          $("#deptFont").text("科室已有")
          $("#deptFont").attr("color","red")
        }
        else {
          stamp.disabled=false
          $("#deptFont").text("√")
          $("#deptFont").attr("color","green")
        }
