                ...
                <div class="btn-group">
                  ...
                  <div id="contes" >
                    <div>
                      ...
                      <div>
                          <form  align="center" >
                              岗位名称：<input type="text" id="checkPostname" name="postname" value="" width="60px" ><br>
                              <font id="postFont"></font><br>
                              <div>
                              ...
                              <input style=" margin-left: 5px;" type="submit" value="提交" id="stamp" onclick="javascript:this.form.action='/addPostinfo'">
                  ...
                  <button type="button" class="btn btn-default" title="刷新" onclick="window.location.href='/getPostinfoAndForward'"><i class="fa fa-refresh"></i> 刷新</button>
                </div>
              </div>
            </div>
            <div class="box-tools pull-right">
              <form action="/getPostinfoLikePostname">
                输入查询岗位名称:<input name="postname">
              ...
              <tbody>
                <c:forEach items="${postinfos}" var="postinfo">
                    <tr align="center">
                       ...
                       <td>${postinfo.postname}</td>
                       <td>
                         <button id="open_btn" class="btn" onclick="show(${postinfo.postid},'${postinfo.postname}')">详情</button>


<%--                       <a href="/deleteDrugInfoServlet?drugid=${deptinfo.deptid}">删除</a>--%>
                       </td>
                    </tr>
                </c:forEach>
              </tbody>
...
<script >
  ...
  $("#checkPostname").blur(function () {
      $.get("http://localhost:8080/checkPostname","postname="+$("#checkPostname").val(),function (data) {
        var stamp = document.getElementById("stamp")
        if(data==1){
          stamp.disabled=true
          $("#postFont").text("岗位已有")
          $("#postFont").attr("color","red")
        }
        else {
          stamp.disabled=false
          $("#postFont").text("√")
          $("#postFont").attr("color","green")
        }
