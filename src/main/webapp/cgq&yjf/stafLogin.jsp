...
<div class="login-box">
    <div class="login-logo">
        ...
        <a href="all-admin-index.html"><b>loginSystem</b></a>
    ...
    <div class="login-box-body">
        ...
        <form action="/stafLogin" method="get">

            <div class="form-group has-feedback">
                <input class="form-control" placeholder="用户名/手机号/Email" name="stafLoginName">
                <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
            </div>

            <div class="form-group has-feedback">
                <input type="password" class="form-control" placeholder="密码" name="stafLoginPassword">
                <span class="glyphicon glyphicon-lock form-control-feedback"></span>
            </div>
            <div align="center">
                <p style="color: red">${stafLoginMsg}</p>
            </div>
<%--            <div>--%>
<%--                &lt;%&ndash;        <input id="sicker" type="radio" name="flag" value="1"><label for="sicker">病人</label>&ndash;%&gt;--%>
